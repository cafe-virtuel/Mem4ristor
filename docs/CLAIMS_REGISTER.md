...
| S07 | **Chaîne GST réaliste : saturation + inertie (Vague 2, étape 2 pathway)** | **36/36 conditions OK** : saturation jusqu'à s=3 × inertie jusqu'à τ_mat=100 pas (à Λ=10). Fonctionnel intact, dead zone H_cog=0.0000 partout | `experiments/photonic_gst_transduction_poc.py` | 10 | 🔍 exploratoire (12/06/2026) — ⚠️ stimulus STATIONNAIRE : l'inertie filtre le bruit sans rien retarder ; aucune contrainte de bande passante matériau en stationnaire (WO₃ « lent » redevient candidat). Stimuli dynamiques = étape 2bis à faire. T(P) générique, courbe GST réelle branchable. Voir `PHOTONIC_PATHWAY.md` §4ter |
