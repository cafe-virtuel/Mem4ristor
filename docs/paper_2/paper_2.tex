...
The spectral dead zone observed on dense Barab\'asi-Albert networks ($m \geq 5$) resists all linear coupling normalization schemes, including degree-linear and spectral normalization (eigenvector centrality). The controlling parameter is not the local degree heterogeneity, but the global path redundancy, parameterized by the algebraic connectivity $\lambda_2$.
