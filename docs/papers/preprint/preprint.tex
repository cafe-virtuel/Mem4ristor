...
(\textit{Left}) Binder cumulant $U_4 = 1 - \langle m^4 \rangle / (3\langle m^2 \rangle^2)$ as a function of the algebraic connectivity $\lambda_2$ for network sizes $N \in \{100, 200, 400, 800, 1600\}$. 
...
(\textit{Right}) Corresponding order parameter $\langle H_{\text{stable}} \rangle$ showing a size-independent universal entropy drop across the critical region, signaling the loss of functional degrees of freedom and the onset of the glass-like arrest. 
