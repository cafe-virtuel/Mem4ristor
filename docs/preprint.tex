...
where $\langle \cdot \rangle$ denotes the ensemble average over $N_{\text{real}} = 40$ independent initial conditions and topological realizations at fixed algebraic connectivity $\lambda_2$. 
...
The Binder cumulant minimum deepens and shifts toward lower $\lambda_2$ with increasing system size, consistent with finite-size scaling theory for a continuous phase transition. At $N=1600$, the minimum has flattened to a broad depression centered near $\lambda_2 \approx 2.3$, suggesting convergence toward the thermodynamic critical point $\lambda_{2,\text{crit}} \approx 2.31$ (Fig.~\ref{fig:binder_cumulant}). The order parameter $\langle H_{\text{stable}} \rangle$ exhibits a smooth, size-independent drop across this region, confirming the physical nature of the transition. While residual finite-size effects remain visible at lower $N$, the convergence trend supports the physical interpretation of the Dead Zone as a genuine thermodynamic phase rather than a numerical artifact. 
...
With increasing $N$, the $U_4$ minimum broadens and flattens, approaching a plateau characteristic of a continuous phase transition in the thermodynamic limit, centered near $\lambda_{2,\text{crit}} \approx 2.31$ (dashed red line). 
...
The inset displays the numerical derivative $|d\langle H \rangle / d\lambda_2|$ for $N=1600$, confirming the critical divergence centered on $\lambda_{2,\text{crit}} \approx 2.31$.
}
