...
def main():
    print("=== HEROIC RUN N=800 ===")
    tasks = []
    p_vals = np.linspace(0.001, 0.0065, 12)
    ...
    if os.path.exists(raw_file):
        ...
        df_old = df_old[df_old['N'] != N_HEROIC] # remove old N=800 if any
    ...
    colors = {100: 'blue', 200: 'orange', 400: 'green', 800: 'red'}
    ...
    ax.axvline(LAMBDA2_CRIT, color='black', linestyle='--', label='λ2_crit (2.31)')
    ...
    print("Figure sauvegardée avec N=800.")
